# 🧠 Terminal Brain (Gemini CLI)

A lightweight, high-speed Command Line Interface for Google Gemini. 
Built for engineers who need answers without leaving the terminal.
